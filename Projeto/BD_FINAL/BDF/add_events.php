...
<div>
    <input type="radio" id="event_type1" name="event_type" value="Standard" <?php echo $disabled; ?>>
    <label for="event_type1"> Standard </label>
</div>
<div>
    <input type="radio" id="event_type2" name="event_type" value="Executive" <?php echo $disabled; ?>>
    <label for="event_type2"> Executive </label>
</div>
<div>
    <input type="radio" id="event_type3" name="event_type" value="Double - Decker " <?php echo $disabled; ?>>
    <label for="event_type3"> Double - Decker </label>
</div>
<div>
    <input type="radio" id="event_type4" name="event_type" value="Minibus" <?php echo $disabled; ?>>
