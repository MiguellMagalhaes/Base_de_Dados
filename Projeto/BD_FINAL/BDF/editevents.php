...
<div>
  ...
  <label for="EventName"> BUS description: </label>
...
<div>
    <input type="radio" id="event_type1" name="event_type" value="Standards" 
    <?php print($row['event_type'] == 'Standards') ? "checked" : "";
    print $disabled; ?>>
    <label for="event_type1"> Standard </label>
</div>
<div>
    <input type="radio" id="event_type2" name="event_type" value="Executive" 
    <?php print($row['event_type'] == 'Executive') ? "checked" : "";
    print $disabled; ?>>
    <label for="event_type2"> Executive </label>
</div>
<div>
    <input type="radio" id="event_type3" name="event_type" value="Double - Decker" 
    <?php print($row['event_type'] == 'Double - Decker') ? "checked" : "";
    print $disabled; ?>>
    <label for="event_type3"> Double - Decker </label>
</div>
<div>
    <input type="radio" id="event_type4" name="event_type" value="Minibus" 
    <?php print($row['event_type'] == 'Minibus') ? "checked" : "";
    print $disabled; ?>>
    <label for="event_type4"> Minibus </label>
</div>
<br>
<div>
    <?php print $statusErr;?>
    <label for="status1"> BUS Status: </label>
...
?>
        <div>
        <?php print"<font color='green'>Service updated successfully.</p>";?>
        </div>
<?php
    }
?>
